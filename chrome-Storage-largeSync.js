largeSync = (function () {
  ...
  function set(items, callback) {
    if (null === items || "string" == typeof items || "Array" === items.constructor.name)
  ...
  if ("undefined" == typeof chrome.storage || "undefined" == typeof chrome.storage.sync)
    throw Error(
  ...
  var f = String.fromCharCode,
    ...
    LZString = {
      ...
      decompressFromUint8Array: function (compressed) {
        ...
        // 2 bytes per character
        for (var buf = new Array(compressed.length / 2), i = 0, TotalLen = buf.length; TotalLen > i; i++)
        ...
        for (ii = 0; ii < uncompressed.length; ii += 1)
          if (
            ...
            Object.prototype.hasOwnProperty.call(context_dictionary, context_c) ||
              ((context_dictionary[context_c] = context_dictSize++), (context_dictionaryToCreate[context_c] = !0)),
            ...
            if (Object.prototype.hasOwnProperty.call(context_dictionaryToCreate, context_w)) {
              ...
              for (value = context_dictionary[context_w], i = 0; context_numBits > i; i++)
                (context_data_val = (context_data_val << 1) | (1 & value)),
                  context_data_position == bitsPerChar - 1
                    ? ((context_data_position = 0),
                      context_data.push(getCharFromInt(context_data_val)),
                  ...
                  (value >>= 1);
            context_enlargeIn--,
              0 == context_enlargeIn && ((context_enlargeIn = Math.pow(2, context_numBits)), context_numBits++), // Add wc to the dictionary.
